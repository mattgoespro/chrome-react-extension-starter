...
export default (_, env: { mode: "none" | "development" | "production" }) => {
  ...
  return {
    ...
    entry: {
      ...
      settings: path.join(__dirname, "src", "renderer", "options-page", "index.tsx"),
      popup: path.join(__dirname, "src", "renderer", "action-popup", "index.tsx")
    },
    output: {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        template: path.join(__dirname, "public", "options-page.html"),
        inject: "body",
        chunks: ["options-page"],
        hash: false
      }),
      new HtmlWebpackPlugin({
        ...
        template: path.join(__dirname, "public", "action-popup.html"),
        inject: "body",
        chunks: ["action-popup"],
        hash: false
      }),
